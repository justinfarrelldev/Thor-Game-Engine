...
let CreateWindow = (windowName) => {
    if (windowName === 'GamePreview') {
        let GamePreviewHTML = '<div id = "GamePreviewWindow" class = "Window">'
            +
        ...
        let el = '        <div id = "ErrorWindow" class = "Window">'
            + '<!--Dropdown for preview menu-->'
            + '<div class = "DropdownDiv">'
            + '<ul class = "Dropdown" onselectstart = "return false;">'
            + '<li style = "position: absolute">'
...
//# sourceMappingURL=generate-windows.js.map