...
const ContextNameError = new Error('There is already a global variable with the name you are trying to supply to the Canvas context. [ContextNameError]')
ContextNameError.name = "ContextNameError"

//const ExportOptions = new EngineWindow('Export Options', 0, ['Build Settings', 'Preferences'])